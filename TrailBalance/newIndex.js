            ...
            if (err) {
                ...
                data.forEach(v => {
                    v.recordArr.forEach(i => {
                        ...
                        if (edate > v.generatedOn && sdate < v.generatedOn) {
                            i.record_type = i.record_type ? i.record_type : 'payment'
                            console.log('ok py')
                            allArr.push({ 'record_no': v.record_no, 'data': i, party_name: v.party.head_of_ac, date: v.generatedOn, balance: startingBalance })
                        } else if (sdate > v.generatedOn) {
